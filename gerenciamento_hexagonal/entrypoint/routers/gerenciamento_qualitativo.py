...
from gerenciamento_hexagonal.application.dependencies import get_gerenciamento_qualitativo_service
...
Service = Annotated[GerenciamentoQualitativoServices, Depends(get_gerenciamento_qualitativo_service)]
